    ...
    >
      ...
      <motion.img
        ...
        className="-mb-20 md:mb-0 flex-shrink-0 w-56 h-56 rounded-full 
          object-cover md:rounded-lg md:w-64 md:h-96 xl:w-[600px] xl:h-[600px]"
      />
      <div className=" space-y-10 px-0 md:px-10">
        <h4 className=" text-4xl font-semibold">Let Me <span className=" underline decoration-[#F7AB0A]/80">Introduce</span>  Myself</h4>
        <p className=" text-lg">
